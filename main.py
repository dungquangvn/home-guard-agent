...
def main(output_queue: Queue, brightness_value):
    cam = Camera(source=0)
    ...
    while True:
        ...
        event_recorder.push(frame_data.image)
...
if __name__ == '__main__':
    ...
    flask_process = Process(target=start_server, args=(frame_queue, shared_brightness))
    flask_process.start()
    
    # 3. Chạy main logic, truyền Queue để nó có thể put frame vào
    try:
        main(frame_queue, shared_brightness)
